...
class GoogleParser
{
	...
	protected $nouns = [
		...
		15 => 'ВОДОЛАЗКА',
		16 => 'ВЬЕТНАМКИ', 17 => 'ГАЛСТУК', 18 => 'ДЖЕГГИНСЫ', 19 => 'ДЖЕГИНСЫ', 20 => 'ДЖЕМПЕР', 21 => 'ДЖИНСЫ', 22 => 'ЖАКЕТ',
		23 => 'ЖИЛЕТ',
		24 => 'ЗОНТ',  25 => 'КАПРИ', 26 => 'КАРДИГАН', 27 => 'КЕДЫ', 28 => 'КЕПКА', 29 => 'КЛЕЕНКА', 30 => 'КОЛГОТКИ',
		31 => 'КОМБИНЕЗОН',
		32 => 'КОНВЕРТ', 33 => 'КОСТЮМ', 34 => 'КОРОБКА', 35 => 'КРОССОВКИ', 36 => 'КУПАЛЬНИК', 37 => 'КУРТКА', 38 => 'ЛЕГГИНСЫ',
		39 => 'ЛЕГИНСЫ', 40 => 'ЛОДОЧКИ', 41 => 'МАЙКА', 42 => 'МОКАСИНЫ', 43 => 'НАГРУДНИК', 44 => 'НАМАТРАСНИК', 45 => 'ОДИ',
		46 => ' ОЧКИ',
